...
export function TrackOrderView({ order, merchant }: TrackOrderViewProps) {
    ...
    <main className="shell" style={{ paddingTop: 24, paddingBottom: 60, maxWidth: 560 }}>
      ...
      <div
        ...
        style={{
          padding: 24,
          marginBottom: 20,
          background: isCancelled ? "#fce4e4" : isDelivered ? "#d4edda" : "var(--card, #fff)",
        }}
      >
                ...
                <div key={step.key} style={{ display: "flex", gap: 12, alignItems: "flex-start" }}>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", width: 40, flexShrink: 0 }}>
                    <div
                      style={{
                        ...
                        height: 32,
                        borderRadius: "50%",
                        border: `2px solid ${isPast ? "var(--mint, #6bfe9c)" : "var(--outline)"}`,
                        background: isPast ? "var(--mint, #6bfe9c)" : isCurrent ? "var(--primary)" : "#fff",
                        color: isPast ? "var(--ink)" : isCurrent ? "#fff" : "var(--muted)",
                        display: "flex",
                        alignItems: "center",
                    ...
                    {idx < fulfilmentSteps.length - 1 && (
                      <div
                        style={{
                          ...
                          flex: 1,
                          minHeight: 24,
                          background: isPast ? "var(--mint, #6bfe9c)" : "var(--surface-container, #e9edff)",
                          margin: "4px 0",
                        }}
                      />
                    )}
                  ...
                  <div style={{ paddingTop: 4, paddingBottom: idx < fulfilmentSteps.length - 1 ? 20 : 0 }}>
                    <p
                      style={{
                        margin: 0,
                        fontWeight: isPast || isCurrent ? 700 : 500,
                        fontSize: "0.94rem",
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8, fontSize: "0.94rem" }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between" }}>
            ...
            <span style={{ fontWeight: 700, color: "var(--primary)", fontFamily: "'Space Grotesk', sans-serif" }}>
              {order.total}
            </span>
          </div>
          <div style={{ display: "flex", justifyContent: "space-between" }}>
        ...
        >
          ⚠️ This is a demo order. No real payment has been processed and no rider has been booked.
        </div>
      </div>
    </main>
  );
