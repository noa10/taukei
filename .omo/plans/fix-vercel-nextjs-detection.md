...
### Definition of Done
- [ ] Root package.json has next in dependencies
- [ ] `bun run build` works locally from root
- [ ] Vercel deployment would pass version detection
...
- [ ] 1. Add Next.js to root package.json dependencies
...
### Final Checklist
- [ ] Next.js in root package.json dependencies
- [ ] Build passes locally
- [ ] Vercel would detect Next.js version